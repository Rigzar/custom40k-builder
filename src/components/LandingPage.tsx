...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v165j_dismissed';
    ...
    <div className="relative mb-6">
      ...
      <div className="bg-zinc-900 border border-zinc-700 border-t-2 border-t-amber-900/80 px-5 pt-14 pb-4">
        ...
        <div className="text-[12px] text-zinc-300 leading-relaxed space-y-2">
          ...
          {/* line15/line14/line13/line12/line11/line10/line9/line8/line7/line6/line5 are prepend
              slots: a follow-up batch of fixes added after the original release leads with the
              newest slot, without renumbering anything below it. 2026-08-24: line7 (Save-bonus
              engine fix), line8 (Tyranids/GK codex sync), line9 (Tyrant Guard Brood HQ-slot
              toggle), line10 (Legion/Taghmata Legacy-armory access), line11 (HH/Legio Titanicus
              ...
              removed), line14 (archetypeArmory/authority tabs now sectioned + picker-aware) and
              line15 (non-Champion Armory weapon purchase count + Stormtrooper plasma gun typo)
              added the same way, keeping v1.65's own banner intact. */}
          {[tx.line15, tx.line14, tx.line13, tx.line12, tx.line11, tx.line10, tx.line9, tx.line8, tx.line7, tx.line6, tx.line5, tx.line1, tx.line2, tx.line3, tx.line4]
            .filter(Boolean)
