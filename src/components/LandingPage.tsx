...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v158d_dismissed';
...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    ...
    line4: '⚠ Changing the battle type to Skirmish no longer deletes your Allied Detachment without warning. A Skirmish may include no allies, so switching to it does have to drop the ally and its units — but it was doing that silently, and switching back does not undo it. Someone reviewing an old list changed the battle type, changed it straight back, and the detachment was gone. It asks first now, and cancelling changes nothing at all.',
