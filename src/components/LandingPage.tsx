...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v173g_dismissed';
...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    ...
    line12: "⚖️ A BALANCE UPDATE FROM THE AUTHOR, in time for the league. TYRANIDS take most of it. EVERY ENDLESS UPGRADE CHANGED PRICE — Barbgaunt 11→17, Ripper Swarms 6→8, Gargoyles 5→7, Hormagaunts, Neurogaunts and Termagants 3→4 — and the GENESTEALER BROOD LOSES ENDLESS ALTOGETHER. The LEGENDARY HIVE TYRANT drops 339→312. The TYRANID WARRIOR BROOD now carries TWO Scything talons instead of talons and Spinefists, swaps one talon in each of its two option groups, and pays 2 points for Spinefists. And the HIVE GUARD, PYROVORE and BIOVORE BROODS are now MONSTROUS INFANTRY. FIVE PSYCHIC POWERS CHANGED TOO: LEVITATION gives +2\" Movement instead of +6\" but casts on a 5, PSIONIC SCOURGE has the profile it was missing, ONSLAUGHT adds Haste(2), and SPECTRAL BLADE and CONCEAL were rewritten. Open any Tyranid list — the total will have moved.",
  ...
  de: {
    ...
    line12: "⚖️ EIN BALANCE-UPDATE VOM AUTOR, rechtzeitig zur Liga. Die TYRANIDEN trifft es am meisten. JEDES ENDLESS-UPGRADE KOSTET NEU — Barbgaunt 11→17, Ripper Swarms 6→8, Gargoyles 5→7, Hormagaunten, Neurogaunten und Termaganten 3→4 — und die GENESTEALER BROOD VERLIERT ENDLESS GANZ. Der LEGENDARY HIVE TYRANT fällt von 339 auf 312. Die TYRANID WARRIOR BROOD trägt jetzt ZWEI Scything talons statt Talons und Spinefists, tauscht in jeder ihrer beiden Optionsgruppen eine Klaue, und Spinefists kosten 2 Punkte. Und HIVE GUARD, PYROVORE und BIOVORE BROOD sind jetzt MONSTROUS INFANTRY. AUCH FÜNF PSI-KRÄFTE ÄNDERN SICH: LEVITATION gibt +2\" Bewegung statt +6\", wird dafür auf 5 gewirkt, PSIONIC SCOURGE hat endlich das fehlende Profil, ONSLAUGHT gibt zusätzlich Haste(2), und SPECTRAL BLADE und CONCEAL wurden neu formuliert. Öffne eine Tyraniden-Liste — die Summe hat sich geändert.",
  ...
  es: {
    ...
    line12: "⚖️ ACTUALIZACIÓN DE EQUILIBRIO DEL AUTOR, a tiempo para la liga. A los TIRÁNIDOS les toca casi todo. TODAS LAS MEJORAS ENDLESS CAMBIAN DE PRECIO — Barbgaunt 11→17, Ripper Swarms 6→8, Gargoyles 5→7, Hormagaunts, Neurogaunts y Termagants 3→4 — y la GENESTEALER BROOD PIERDE ENDLESS POR COMPLETO. El LEGENDARY HIVE TYRANT baja de 339 a 312. La TYRANID WARRIOR BROOD lleva ahora DOS Scything talons en vez de talons y Spinefists, cambia una garra en cada uno de sus dos grupos de opciones, y los Spinefists cuestan 2 puntos. Y HIVE GUARD, PYROVORE y BIOVORE BROOD pasan a ser MONSTROUS INFANTRY. TAMBIÉN CAMBIAN CINCO PODERES PSÍQUICOS: LEVITATION da +2\" de Movimiento en vez de +6\" pero se lanza con 5, PSIONIC SCOURGE ya tiene el perfil que le faltaba, ONSLAUGHT añade Haste(2), y SPECTRAL BLADE y CONCEAL se han reescrito. Abre cualquier lista tiránida — el total habrá cambiado.",
