...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v161c_dismissed';
...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    title: "v1.61: every codex checked against the author’s sheets",
    intro: "We compared all 19 factions with the source spreadsheets field by field — sizes, points, stats, weapons, loadouts, option prices. Worth checking your lists:",
    install: "⚖ Inquisition took the most corrections. Every retinue specialist was capped at 6, which is the Warband limit and not their own: Chirurgeons, Daemonhosts, Missionaries, Psykers and Xenologists are 1, while Acolytes go to 12 and Arco-flagellants to 10. Land Raider Prometheus 395, Chimera 186 (BS 4+), Taurox 120 (S5), plus four option prices.",
    line1: "⚔ Harlequins — a Troupe is 5 Players minimum and Skyweavers come in 2s. Imperial Guard — a Heavy Weapon Squad can field 9 teams, not 3. Genestealer Cults — Purestrain Genestealers are Initiative 5.",
    line2: "🔧 Squads no longer list the weapons of a special model you did not buy. Corsair Voidscarred showed the Shade Runner’s blades, the Soul Weaver’s power sword and the Way Seeker’s witch staff regardless; Sisters Novitiate, Repentia, Atalan Jackals, Gretchins, Snotlings and three Tau battlesuits had the same gap.",
    line3: "🔩 Space Marines — the Indomitus Crusader Squad now shows Neophytes, Initiates and the Sword Brother as separate rows with their own gear, and an Initiate's swapped weapon counts once instead of once per Initiate.",
    line4: "🐛 Three of your reports, all Eldar. A War Walker that swaps one of its two Scatter lasers keeps the other — our own regression from v1.59 (#86). Guardian Defenders only show the heavy weapon once a platform is in the squad (#87). And swapping that platform's Scatter laser now puts the new weapon on the PLATFORM at the quantity you bought — it was being piled onto the Defenders, so a ten-model squad read as ten missile launchers, and the platform kept a laser it had traded away (#89).",
    line5: "☠ Necrons — Reanimation Protocols was the wrong rule entirely. The codex prints two versions and we had the one headed “Experimental Rules”; it now shows the real one, with Reanimation Points.",
    line6: "☠ Chaos Space Marines — a Great Unclean One does not fill your mandatory HQ, and the app now tells you why instead of just showing a zero. The Summoning rule stops Chaos Daemons filling mandatory slots; Daemonkin is the archetype that ignores it. The rule was always right, the message was not (#88).",
    contrib: "👁️ If a unit of yours changed points, this is why. Anything that still looks wrong: unit, engagement, archetype and a picture — and Review → ↓ JSON if the list itself misbehaves.",
  },
  de: {
    title: "v1.61: jeder Codex gegen die Tabellen des Autors geprüft",
    intro: "Alle 19 Fraktionen wurden Feld für Feld mit den Quelltabellen verglichen — Größen, Punkte, Werte, Waffen, Ausrüstung, Optionspreise. Prüft eure Listen:",
    install: "⚖ Die Inquisition hatte die meisten Korrekturen. Jeder Gefolge-Spezialist war auf 6 begrenzt — das ist das Warband-Limit, nicht das eigene: Chirurgeons, Daemonhosts, Missionaries, Psykers und Xenologists sind 1, Acolytes gehen bis 12 und Arco-flagellants bis 10. Land Raider Prometheus 395, Chimera 186 (BF 4+), Taurox 120 (St5), dazu vier Optionspreise.",
    line1: "⚔ Harlequins — eine Troupe hat mindestens 5 Player, Skyweavers kommen zu zweit. Imperial Guard — ein Heavy Weapon Squad darf 9 Teams stellen, nicht 3. Genestealer Cults — Purestrain Genestealers haben Initiative 5.",
    line2: "🔧 Trupps listen keine Waffen mehr von Spezialmodellen, die ihr nicht gekauft habt. Corsair Voidscarred zeigten die Klingen des Shade Runners, das Energieschwert des Soul Weavers und den Hexenstab des Way Seekers unabhängig davon; Sisters Novitiate, Repentia, Atalan Jackals, Gretchins, Snotlings und drei Tau-Kampfanzüge hatten dieselbe Lücke.",
    line3: "🔩 Space Marines — der Indomitus Crusader Squad zeigt Neophytes, Initiates und den Sword Brother jetzt als eigene Zeilen mit eigener Ausrüstung, und die getauschte Waffe eines Initiate zählt einmal statt einmal pro Initiate.",
    line4: "🐛 Drei eurer Meldungen, alle Eldar. Ein War Walker, der einen seiner beiden Scatter Laser tauscht, behält den anderen — unser eigener Fehler aus v1.59 (#86). Guardian Defenders zeigen die schwere Waffe erst, wenn eine Plattform im Trupp steht (#87). Und der Tausch des Plattform-Scatter-Lasers legt die neue Waffe jetzt auf die PLATTFORM, in der gekauften Anzahl — sie landete vorher bei den Defenders, ein Zehner-Trupp las sich also als zehn Raketenwerfer, und die Plattform behielt einen Laser, den sie abgegeben hatte (#89).",
    line5: "☠ Necrons — Reanimation Protocols war die komplett falsche Regel. Der Codex druckt zwei Fassungen, und wir hatten die unter „Experimental Rules“; jetzt steht dort die echte, mit Reanimation Points.",
    line6: "☠ Chaos Space Marines — ein Great Unclean One füllt euren Pflicht-HQ-Slot nicht, und die App sagt jetzt auch warum, statt nur eine Null zu zeigen. Die Beschwörungs-Regel verbietet Chaos Daemons in Pflicht-Slots; Daemonkin ist der Archetyp, der sie ignoriert. Die Regel stimmte immer, die Meldung nicht (#88).",
  ...
  es: {
    title: "v1.61: todos los códex revisados contra las hojas del autor",
    intro: "Hemos comparado las 19 facciones con las hojas fuente campo a campo — tamaños, puntos, stats, armas, equipo, precios de opciones. Conviene revisar vuestras listas:",
    install: "⚖ La Inquisición se llevó la mayoría. Cada especialista del séquito estaba limitado a 6, que es el tope del Warband y no el suyo: Chirurgeons, Daemonhosts, Missionaries, Psykers y Xenologists son 1, mientras que los Acolytes llegan a 12 y los Arco-flagellants a 10. Land Raider Prometheus 395, Chimera 186 (HP 4+), Taurox 120 (F5), y cuatro precios de opciones.",
    line1: "⚔ Harlequins — una Troupe son 5 Players mínimo y los Skyweavers vienen de 2 en 2. Imperial Guard — un Heavy Weapon Squad puede llevar 9 equipos, no 3. Genestealer Cults — los Purestrain Genestealers tienen Iniciativa 5.",
    line2: "🔧 Las escuadras ya no listan las armas de un modelo especial que no has comprado. Los Corsair Voidscarred enseñaban las cuchillas del Shade Runner, la espada del Soul Weaver y el bastón del Way Seeker pasara lo que pasara; Sisters Novitiate, Repentia, Atalan Jackals, Gretchins, Snotlings y tres trajes tau tenían el mismo hueco.",
    line3: "🔩 Space Marines — el Indomitus Crusader Squad ya muestra Neophytes, Initiates y el Sword Brother como filas separadas con su propio equipo, y el arma cambiada de un Initiate cuenta una vez en lugar de una por cada Initiate.",
    line4: "🐛 Tres de vuestros reportes, todos eldar. Un War Walker que cambia uno de sus dos Scatter lasers conserva el otro — ese fallo era nuestro, de la v1.59 (#86). Los Guardian Defenders solo enseñan el arma pesada cuando hay plataforma en la escuadra (#87). Y al cambiar el Scatter laser de esa plataforma, el arma nueva va ahora a la PLATAFORMA y en la cantidad que compraste — antes se amontonaba en los Defenders, así que una escuadra de diez se leía como diez lanzamisiles, y la plataforma se quedaba un láser que ya había cambiado (#89).",
    line5: "☠ Necrones — Reanimation Protocols era directamente la regla equivocada. El códex imprime dos versiones y teníamos la de “Experimental Rules”; ahora sale la buena, con Reanimation Points.",
    line6: "☠ Chaos Space Marines — un Great Unclean One no cubre tu HQ obligatorio, y ahora la app te dice por qué en vez de enseñarte un cero. La regla de Invocación impide que los Chaos Daemons cubran slots obligatorios; Daemonkin es el arquetipo que la ignora. La regla siempre estuvo bien, el mensaje no (#88).",
