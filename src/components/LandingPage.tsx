...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v157_dismissed';
...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  ...
  de: {
    title: 'v1.57: Necrons-Codex 1.1 und ein neu geschriebenes Regelglossar',
    intro: 'Ein neues Necron-Dokument und ein neues Core-Rules-Dokument sind eingetroffen. Das hat sich geändert:',
    install: '',
    line1: '⚙ Necrons (1.1) — der Cryptek wurde neu gebaut. Er muss jetzt eine von ACHT Spezialisierungen nehmen statt fünf, jede mit eigenem Preis (Dynasty Scion +14, Astromancer +17, Chronomancer +27, Ethermancer +30, Technomancer +35, Geomancer +40, Plasmancer +45, Psychomancer +56). Sieben davon bringen ihre eigene Waffe mit, und jede verändert, wie zwei bestimmte Rüstkammer-Gegenstände funktionieren — diese Gegenstände kauft man weiterhin normal, die Spezialisierung verbessert sie nur.',
