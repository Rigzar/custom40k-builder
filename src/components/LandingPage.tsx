...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v173a_dismissed';
...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    ...
    line4: "💰 TWO NUMBERS WERE WRONG. The TYRANID NEUROTHROPE cost 120 points when the codex says 95 — the upgrade is free and you have been paying 25 points for it. The CHAOS ASCENDED DAEMON PRINCE moved 6\" instead of 8\". Also: one psychic power, Space Marine ENGULFING FEAR, was missing its entire effect.",
    ...
    line6: "🔍 THESE ARE THE FIRST RESULTS, NOT THE LAST. The check is still running, so expect more fixes in the next versions. Keep reporting anything that looks wrong — your reports are what tell us where to look first.",
    line7: "",
    line8: "",
    line9: "",
  ...
  de: {
    ...
    line4: "💰 ZWEI ZAHLEN WAREN FALSCH. Der TYRANIDEN-NEUROTHROPE kostete 120 Punkte, im Codex stehen 95 — die Aufwertung ist kostenlos und ihr habt 25 Punkte dafür bezahlt. Der AUFGESTIEGENE DÄMONENPRINZ bewegte sich 6\" statt 8\". Außerdem fehlte einer Psi-Kraft, ENGULFING FEAR der Space Marines, ihre gesamte Wirkung.",
    ...
    line6: "🔍 DAS SIND DIE ERSTEN ERGEBNISSE, NICHT DIE LETZTEN. Die Prüfung läuft weiter, es kommen also weitere Korrekturen in den nächsten Versionen. Meldet weiterhin alles, was falsch aussieht — eure Meldungen sagen uns, wo wir zuerst hinschauen.",
    line7: "",
    line8: "",
    line9: "",
  ...
  es: {
    ...
    line4: "💰 DOS NÚMEROS ESTABAN MAL. El NEUROTHROPE tyránido costaba 120 puntos y el códex dice 95 — la mejora es gratis y llevabas pagando 25 puntos. El PRÍNCIPE DEMONIO ASCENDIDO movía 6\" en vez de 8\". Además, a un poder psíquico, ENGULFING FEAR de Space Marines, le faltaba todo su efecto.",
    ...
    line6: "🔍 ESTOS SON LOS PRIMEROS RESULTADOS, NO LOS ÚLTIMOS. La revisión sigue, así que habrá más arreglos en las siguientes versiones. Seguid reportando cualquier cosa que parezca mal — vuestros reportes son lo que nos dice dónde mirar primero.",
    line7: "",
    line8: "",
    line9: "",
