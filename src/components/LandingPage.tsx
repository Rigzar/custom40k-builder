...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    ...
    line3: "⚔️ A WEAPON YOU PAID FOR WAS MISSING FROM YOUR CARD, in five places. Some wargear works by giving you a weapon: you buy the item, and the weapon should appear on your datasheet with its profile. In these five cases the app took the points and printed no weapon at all. The HUNTER-KILLER MISSILE on Space Marine, Imperial Guard, Adeptus Custodes and Adeptus Sororitas vehicles — 5 points, no missile on the sheet. And the TAU XV81 CRISIS BATTLESUIT’s Smart missile system. Your totals were always right; it was the card that was short a row. Open one of those lists again and the weapon is there.",
  ...
  de: {
    ...
    line3: "⚔️ EINE WAFFE, FÜR DIE IHR BEZAHLT HABT, FEHLTE AUF DER KARTE — an fünf Stellen. Manche Ausrüstung funktioniert so, dass sie euch eine Waffe gibt: ihr kauft das Teil, und die Waffe soll mit ihrem Profil auf dem Datenblatt erscheinen. In diesen fünf Fällen nahm die App die Punkte und druckte gar keine Waffe. Das HUNTER-KILLER MISSILE auf Fahrzeugen der Space Marines, der Imperialen Armee, der Custodes und der Sororitas — 5 Punkte, keine Rakete auf dem Blatt. Und das Smart missile system des TAU XV81 CRISIS BATTLESUIT. Eure Gesamtpunkte stimmten immer; auf der Karte fehlte nur eine Zeile. Öffnet so eine Liste erneut und die Waffe steht da.",
  ...
  es: {
    ...
    line3: "⚔️ UN ARMA QUE HABÍAS PAGADO NO SALÍA EN TU FICHA, en cinco sitios. Hay equipo que funciona dándote un arma: compras el objeto y el arma debería aparecer en la ficha con su perfil. En estos cinco casos la app te cobraba los puntos y no imprimía arma ninguna. El HUNTER-KILLER MISSILE en vehículos de Space Marines, Guardia, Custodes y Sororitas — 5 puntos y ningún misil en la hoja. Y el Smart missile system del TAU XV81 CRISIS BATTLESUIT. Tus totales siempre estuvieron bien; lo que faltaba era una fila en la ficha. Abre una de esas listas otra vez y el arma está ahí.",
