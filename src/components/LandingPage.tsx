...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v160_dismissed';
...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    title: 'v1.60: Adeptus Mechanicus codex update',
    intro: 'A new codex from the author. What it changes for your lists:',
    install: '⚙ Bionics is wargear now, not a printed rule — it shows in the loadout, and the 6+ ward save is unchanged. Servitors drop to 10 pts (they are the one unit that genuinely lost it), the Skitarii Marshal goes to Leadership 8, and the Magos, Skitarii Marshal and Tech-Priest can take a Doctrina Imperative.',
    line1: '📖 The Legio Titanicus supplement is now Forces of the Machine God, and its archetype is Taghmata. Lists saved with Titan Legion keep working.',
    line2: '🔧 Five datasheets moved into it, all rewritten by the author: Secutarii Hoplites, Secutarii Peltasts, Tech-thralls, the Macrocarid Explorator (281 pts, was 408) and the new Triaros Armored Conveyor.',
    line3: '',
  ...
  de: {
    title: 'v1.60: Adeptus-Mechanicus-Codex aktualisiert',
    intro: 'Ein neuer Codex vom Autor. Was sich für eure Listen ändert:',
    install: '⚙ Bionics ist jetzt Ausrüstung statt gedruckter Regel — es steht in der Ausrüstungszeile, der 6+ Ward Save bleibt gleich. Servitoren kosten 10 Punkte (sie sind die einzige Einheit, die es wirklich verloren hat), der Skitarii Marshal geht auf Führung 8, und Magos, Skitarii Marshal und Tech-Priest dürfen ein Doctrina Imperative nehmen.',
    line1: '📖 Das Legio-Titanicus-Supplement heißt jetzt Forces of the Machine God, sein Archetyp Taghmata. Mit Titan Legion gespeicherte Listen funktionieren weiter.',
    line2: '🔧 Fünf Datenblätter sind dorthin gewandert, alle vom Autor neu geschrieben: Secutarii Hoplites, Secutarii Peltasts, Tech-thralls, der Macrocarid Explorator (281 statt 408 Punkte) und der neue Triaros Armored Conveyor.',
    line3: '',
  ...
  es: {
    title: 'v1.60: códex de Adeptus Mechanicus actualizado',
    intro: 'Un códex nuevo del autor. Lo que cambia para vuestras listas:',
    install: '⚙ Bionics ahora es equipo, no una regla impresa — sale en la línea de equipo y el salvamento de 6+ no cambia. Los Servitors bajan a 10 puntos (son la única unidad que lo perdió de verdad), el Skitarii Marshal sube a Liderazgo 8, y el Magos, el Skitarii Marshal y el Tech-Priest pueden coger un Doctrina Imperative.',
    line1: '📖 El suplemento Legio Titanicus pasa a llamarse Forces of the Machine God, y su arquetipo es Taghmata. Las listas guardadas con Titan Legion siguen funcionando.',
    line2: '🔧 Cinco fichas se han mudado allí, todas reescritas por el autor: Secutarii Hoplites, Secutarii Peltasts, Tech-thralls, el Macrocarid Explorator (281 puntos, antes 408) y el nuevo Triaros Armored Conveyor.',
    line3: '',
