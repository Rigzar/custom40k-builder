...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v159c_dismissed';
...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    ...
    line6: '🔱 The Reaver Lord works end to end. “Select a single item from any Space Marine or Chaos Space Marine Armory for the stated cost” — take it and a searchable picker opens underneath, listing every Chaos armoury and every Space Marine one. Pick an item and it is added at its own price with its own profile and rules: a Space Marine weapon borrowed onto a Chaos character shows its real stats on the card and in print. Anything you may not legally take is greyed out, so the “requirements must be met” clause and the once-per-army limit are handled for you, and removing the Reaver Lord removes whatever it fetched. Thanks to whoever flagged this on Discord before we had even opened the sheet.',
    ...
    line3: '',
    line4: '🐛 Three from your reports. ⚔ Eldar — a War Walker carries two Scatter lasers and its datasheet lets you swap EACH of them, but the app allowed one swap per model: a squadron of two ended up with a single replaced weapon instead of four. Fixed here and on the five other datasheets worded the same way (Custodes Telemon, Chaos Decimator, Eldar Hornets, Tau Ghostkeel and Hazard Battlesuits). · 🛡 Space Marines — the Dreadnought no longer carries a Flamestorm cannon you cannot remove; it was never among the eleven weapons its datasheet offers. The Ironclad is the Dreadnought that can take one. · ⚒ Leagues of Votann — with the Demiurg archetype the Tau now show as green Battle Brothers, which is what the archetype says; the app had been keeping the standard Allies of Convenience.',
  ...
  de: {
    ...
    line6: '🔱 Der Reaver Lord funktioniert vollständig. „Select a single item from any Space Marine or Chaos Space Marine Armory for the stated cost“ — nimm ihn, und darunter öffnet sich eine durchsuchbare Auswahl mit allen Chaos-Armories und allen Space-Marine-Armories. Der gewählte Gegenstand wird zu seinem eigenen Preis mit eigenem Profil und eigenen Regeln hinzugefügt: Eine Space-Marine-Waffe an einem Chaos-Charakter zeigt ihre echten Werte auf der Karte und im Druck. Was du nicht nehmen darfst, ist ausgegraut — die Klausel „requirements must be met“ und das Einmal-pro-Armee-Limit übernehmen wir. Entfernst du den Reaver Lord, verschwindet auch das Geholte. Danke an den, der das auf Discord gemeldet hat, bevor wir die Tabelle überhaupt geöffnet hatten.',
    ...
    line3: '',
    line4: '🐛 Drei aus euren Meldungen. ⚔ Eldar — ein War Walker trägt zwei Scatter Laser und darf laut Datenblatt JEDEN davon tauschen, die App erlaubte aber nur einen Tausch pro Modell: Ein Trupp aus zweien endete mit einer statt vier getauschten Waffen. Behoben, ebenso auf den fünf gleich formulierten Datenblättern (Custodes Telemon, Chaos Decimator, Eldar Hornets, Tau Ghostkeel und Hazard Battlesuits). · 🛡 Space Marines — der Dreadnought trägt keine unentfernbare Flamestorm-Kanone mehr; sie stand nie unter den elf Waffen, die sein Datenblatt anbietet. Der Ironclad ist der Dreadnought, der eine nehmen kann. · ⚒ Leagues of Votann — mit dem Demiurg-Archetyp gelten die Tau jetzt als grüne Battle Brothers, wie der Archetyp es sagt; bisher blieb es bei Allies of Convenience.',
  ...
  es: {
    ...
    line6: '🔱 El Reaver Lord funciona de principio a fin. “Select a single item from any Space Marine or Chaos Space Marine Armory for the stated cost” — cógelo y debajo se abre un selector con buscador, con todas las armerías de Caos y todas las de Space Marines. El objeto elegido se añade a su propio precio, con su perfil y sus reglas: un arma de Space Marines prestada a un personaje del Caos muestra sus estadísticas reales en la ficha y al imprimir. Lo que no puedas coger legalmente sale en gris, así que la cláusula de “requirements must be met” y el límite de una por ejército los llevamos nosotros. Y si quitas el Reaver Lord, se va con él lo que hubiera traído. Gracias a quien lo avisó por Discord antes incluso de que abriéramos la hoja.',
    ...
    line3: '',
    line4: '🐛 Tres de vuestros reportes. ⚔ Eldar — un War Walker lleva dos Scatter lasers y su ficha permite cambiar CADA uno, pero la app solo dejaba un cambio por modelo: una escuadra de dos acababa con un arma cambiada en vez de cuatro. Corregido aquí y en las otras cinco fichas redactadas igual (Telemon de Custodes, Decimator del Caos, Hornets eldar, y Ghostkeel y Hazard de Tau). · 🛡 Space Marines — el Dreadnought ya no lleva un Flamestorm cannon que no se podía quitar; nunca estuvo entre las once armas que ofrece su ficha. El Ironclad es el Dreadnought que sí puede llevarlo. · ⚒ Leagues of Votann — con el arquetipo Demiurg los Tau salen ya como Battle Brothers verdes, que es lo que dice el arquetipo; la app seguía aplicando Allies of Convenience.',
