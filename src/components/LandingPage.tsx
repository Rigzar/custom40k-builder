...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v157b_dismissed';
...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    title: 'v1.57: a new supplement, Necrons 1.1, and a rewritten rules glossary',
    intro: 'A new Necron document and a new Core Rules document both landed. Here is what changed:',
    install: '',
    line1: '⚔ New supplement — Horus Heresy Legio Titanicus, unlocked by the Adeptus Mechanicus “Titan Legion” archetype. One unit for now, the Secutarii Axiarch, with its own armoury (Arc lance, Frag and Rad grenades, Mag-inverter shield). The Space Marine supplement is now the Horus Heresy Legiones Astartes Supplement and gained the Saturnine Terminator Squad; Cataphractii Terminators are Toughness 5. “Rad” joins the glossary as a weapon ability, and in “Tug of War” the relic scores 400/800 VP and can never board a transport. · ⚙ Necrons (1.1) — the Cryptek is rebuilt. It must now take one of EIGHT specialisations instead of five, each at its own price (Dynasty Scion +14, Astromancer +17, Chronomancer +27, Ethermancer +30, Technomancer +35, Geomancer +40, Plasmancer +45, Psychomancer +56). Seven of them come with their own weapon, and each one changes how two specific pieces of Armory wargear work — you still buy those items normally, the specialisation only improves them.',
    line2: '⚙ Necrons (1.1) — the “Canoptek Court” archetype now also lifts the one-per-army limit on specialisations, so you can field two Plasmancers. Cryptothralls finally carry the Canoptek keyword, so the archetype reaches them too.',
    line3: '⚙ Necrons (1.1) — points: Flayed Ones 20, Immortals 40, Warriors 18, Deathmarks 63, Lychguard 54, Skorpekh 47, Ophydian 50, Tomb Blades 44, Triarch Praetorians 61, Canoptek Reanimator 144, Lokhust Destroyers 111. Eight upgrade costs changed too. “Dispersion Shields” and “Shadowloom” no longer give a ward save, and the Rod of covenant does 1 Damage shooting but gains AT(1) in melee.',
    line4: '⚙ Necrons (1.1) — the whole Armory was reworked: nine new items, six new weapons, and most of the rest changed price, effect or both (the Chronometron went from a 6+ save to “re-roll any one die”, and from 20 points to 5). A few were renamed or removed — “Gaze of the flame” is now “Gaze of Flame”, “Solar impulse” is “Solar Pulse”, “Harbinger of Destruction” is “Living Lightning”, and “Harbinger of Despair”, “Eldritch lance” and “Entropic lance” are gone. If a saved Necron list comes back wrong because of this, send us its .json on Discord and we will repair it and send it back.',
    line5: '📖 Everyone — all 67 rules that the new Core Rules document changed were rewritten word for word from it. The big one: “invulnerability save” is now “ward save” everywhere (Daemon 5+, Greater Daemon 4+, Berserk, Shield Breaker). “Monofilament” no longer needs the target to be in cover, “Graviton” now also turns the target’s cover into difficult and dangerous terrain, “Flurry” does not block the model’s own extra attacks, “Retribution” pools across models, “Command Squad” can join a squad that already has a character, “Outflank” may not deploy in the enemy deployment zone or on turn 1, and “Daemonic Instability” causes Mortal Wounds. Deep Strike, Infiltrator, Vanguard, Open, Bodyguard, Suppression, Overheating and Narthecium now carry the full detail the rulebook prints.',
    line6: '🔄 Everyone — the “Update now” button on the new-version notice sometimes did nothing, because it waited for a browser event that never arrived if another tab had already taken the update. It now says “Updating…” and reloads by itself.',
  ...
  de: {
    title: 'v1.57: eine neue Erweiterung, Necrons 1.1 und ein neu geschriebenes Regelglossar',
    intro: 'Ein neues Necron-Dokument und ein neues Core-Rules-Dokument sind eingetroffen. Das hat sich geändert:',
    install: '',
    line1: '⚔ Neue Erweiterung — Horus Heresy Legio Titanicus, freigeschaltet durch den Adeptus-Mechanicus-Archetyp „Titan Legion“. Vorerst eine Einheit, der Secutarii Axiarch, mit eigener Rüstkammer (Arc lance, Frag- und Rad-Granate, Mag-inverter shield). Die Space-Marine-Erweiterung heißt jetzt Horus Heresy Legiones Astartes Supplement und hat den Saturnine Terminator Squad bekommen; Cataphractii-Terminatoren haben Widerstand 5. „Rad“ ist als Waffenfähigkeit im Glossar, und in „Tug of War“ bringt das Relikt 400/800 VP und kann nie einen Transporter besteigen. · ⚙ Necrons (1.1) — der Cryptek wurde neu gebaut. Er muss jetzt eine von ACHT Spezialisierungen nehmen statt fünf, jede mit eigenem Preis (Dynasty Scion +14, Astromancer +17, Chronomancer +27, Ethermancer +30, Technomancer +35, Geomancer +40, Plasmancer +45, Psychomancer +56). Sieben davon bringen ihre eigene Waffe mit, und jede verändert, wie zwei bestimmte Rüstkammer-Gegenstände funktionieren — diese Gegenstände kauft man weiterhin normal, die Spezialisierung verbessert sie nur.',
    line2: '⚙ Necrons (1.1) — der Archetyp „Canoptek Court“ hebt jetzt auch die Ein-pro-Armee-Grenze der Spezialisierungen auf, zwei Plasmancer sind also möglich. Cryptothralls tragen endlich das Schlüsselwort Canoptek, damit der Archetyp auch sie erreicht.',
    line3: '⚙ Necrons (1.1) — Punkte: Flayed Ones 20, Immortals 40, Warriors 18, Deathmarks 63, Lychguard 54, Skorpekh 47, Ophydian 50, Tomb Blades 44, Triarch Praetorians 61, Canoptek Reanimator 144, Lokhust Destroyers 111. Acht Upgrade-Kosten haben sich ebenfalls geändert. „Dispersion Shields“ und „Shadowloom“ geben keinen Ward Save mehr, und der Rod of covenant macht im Beschuss 1 Schaden, gewinnt dafür AT(1) im Nahkampf.',
    line4: '⚙ Necrons (1.1) — die gesamte Rüstkammer wurde überarbeitet: neun neue Gegenstände, sechs neue Waffen, und beim Rest änderten sich Preis, Effekt oder beides (das Chronometron ging von einem 6+ Save auf „einen beliebigen Würfel neu würfeln“ und von 20 auf 5 Punkte). Einige wurden umbenannt oder entfernt — „Gaze of the flame“ heißt jetzt „Gaze of Flame“, „Solar impulse“ ist „Solar Pulse“, „Harbinger of Destruction“ ist „Living Lightning“, und „Harbinger of Despair“, „Eldritch lance“ und „Entropic lance“ gibt es nicht mehr. Falls dadurch eine gespeicherte Necron-Liste fehlerhaft zurückkommt, schick uns ihre .json auf Discord — wir reparieren sie und schicken sie zurück.',
    line5: '📖 Für alle — alle 67 Regeln, die das neue Core-Rules-Dokument geändert hat, wurden wortgetreu daraus übernommen. Das Wichtigste: „Unverwundbarkeitsrettungswurf“ heißt jetzt überall „Ward Save“ (Daemon 5+, Greater Daemon 4+, Berserk, Shield Breaker). „Monofilament“ braucht das Ziel nicht mehr in Deckung, „Graviton“ verwandelt die Deckung des Ziels zusätzlich in schwieriges und gefährliches Gelände, „Flurry“ blockiert die eigenen Zusatzattacken nicht, „Retribution“ wird über mehrere Modelle gepoolt, „Command Squad“ darf sich einer Einheit anschließen, die bereits einen Charakter hat, „Outflank“ darf nicht in der gegnerischen Aufstellungszone und nicht in Runde 1 aufgestellt werden, und „Daemonic Instability“ verursacht Mortal Wounds. Deep Strike, Infiltrator, Vanguard, Open, Bodyguard, Suppression, Overheating und Narthecium tragen jetzt die vollen Details aus dem Regelbuch.',
    line6: '🔄 Für alle — der Knopf „Jetzt aktualisieren“ im Update-Hinweis tat manchmal nichts, weil er auf ein Browser-Ereignis wartete, das nie kam, wenn ein anderer Tab das Update schon übernommen hatte. Jetzt zeigt er „Wird aktualisiert…“ und lädt selbst neu.',
  ...
  es: {
    title: 'v1.57: suplemento nuevo, Necrons 1.1 y glosario reescrito',
    intro: 'Han llegado un documento nuevo de Necrons y uno nuevo de Core Rules. Esto es lo que cambió:',
    install: '',
    line1: '⚔ Suplemento nuevo — Horus Heresy Legio Titanicus, que desbloquea el arquetipo “Titan Legion” de Adeptus Mechanicus. Por ahora una unidad, el Secutarii Axiarch, con su propia armería (Arc lance, granadas Frag y Rad, Mag-inverter shield). El suplemento de Space Marines pasa a llamarse Horus Heresy Legiones Astartes Supplement y suma el Saturnine Terminator Squad; los Cataphractii tienen Resistencia 5. “Rad” entra en el glosario como habilidad de arma, y en “Tug of War” la reliquia da 400/800 VP y no puede subir nunca a un transporte. · ⚙ Necrons (1.1) — el Cryptek se ha rehecho. Ahora debe coger una de OCHO especializaciones en vez de cinco, cada una con su precio (Dynasty Scion +14, Astromancer +17, Chronomancer +27, Ethermancer +30, Technomancer +35, Geomancer +40, Plasmancer +45, Psychomancer +56). Siete traen su propia arma, y cada una cambia cómo funcionan dos objetos concretos de la armería — esos objetos se siguen comprando aparte, la especialización solo los mejora.',
    line2: '⚙ Necrons (1.1) — el arquetipo “Canoptek Court” ahora también levanta el límite de una especialización por ejército, así que puedes llevar dos Plasmancer. Los Cryptothralls por fin llevan la palabra clave Canoptek, con lo que el arquetipo también les alcanza.',
    line3: '⚙ Necrons (1.1) — puntos: Flayed Ones 20, Immortals 40, Warriors 18, Deathmarks 63, Lychguard 54, Skorpekh 47, Ophydian 50, Tomb Blades 44, Triarch Praetorians 61, Canoptek Reanimator 144, Lokhust Destroyers 111. Ocho costes de opción también cambiaron. “Dispersion Shields” y “Shadowloom” ya no dan ward save, y el Rod of covenant hace 1 de Daño disparando pero gana AT(1) en cuerpo a cuerpo.',
    line4: '⚙ Necrons (1.1) — la armería entera se rehizo: nueve objetos nuevos, seis armas nuevas, y casi todo lo demás cambió de precio, de efecto o de ambos (el Chronometron pasó de un save de 6+ a “repetir un dado cualquiera”, y de 20 puntos a 5). Algunos se renombraron o desaparecieron — “Gaze of the flame” ahora es “Gaze of Flame”, “Solar impulse” es “Solar Pulse”, “Harbinger of Destruction” es “Living Lightning”, y “Harbinger of Despair”, “Eldritch lance” y “Entropic lance” ya no están. Si por esto una lista guardada de Necrons vuelve mal, mándanos su .json por Discord y te la arreglamos.',
    line5: '📖 Para todos — las 67 reglas que cambió el nuevo documento de Core Rules se han reescrito palabra por palabra desde él. Lo más importante: “tirada de salvación invulnerable” ahora es “ward save” en todas partes (Daemon 5+, Greater Daemon 4+, Berserk, Shield Breaker). “Monofilament” ya no necesita que el objetivo esté en cobertura, “Graviton” además convierte la cobertura del objetivo en terreno difícil y peligroso, “Flurry” no impide los ataques extra propios del modelo, “Retribution” se acumula entre modelos, “Command Squad” puede unirse a una unidad que ya tiene un personaje, “Outflank” no puede desplegar en la zona enemiga ni en el turno 1, y “Daemonic Instability” causa Heridas Mortales. Deep Strike, Infiltrator, Vanguard, Open, Bodyguard, Suppression, Overheating y Narthecium llevan ya todo el detalle que imprime el reglamento.',
    line6: '🔄 Para todos — el botón “Actualizar ahora” del aviso de versión nueva a veces no hacía nada, porque esperaba un evento del navegador que no llegaba si otra pestaña ya se había quedado con la actualización. Ahora pone “Actualizando…” y recarga solo.',
