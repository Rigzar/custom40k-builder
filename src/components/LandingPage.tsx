...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    ...
    line3: "",
    line4: "🐛 Your two reports. A War Walker that swaps one of its two Scatter lasers keeps the other — that one was our own regression from v1.59 (#86). And Guardian Defenders only show the heavy weapon once a platform is actually in the squad (#87).",
  ...
  de: {
    ...
    line3: "",
    line4: "🐛 Eure zwei Meldungen. Ein War Walker, der einen seiner beiden Scatter Laser tauscht, behält den anderen — das war unser eigener Fehler aus v1.59 (#86). Und Guardian Defenders zeigen die schwere Waffe erst, wenn wirklich eine Plattform im Trupp steht (#87).",
  ...
  es: {
    ...
    line3: "",
    line4: "🐛 Vuestros dos reportes. Un War Walker que cambia uno de sus dos Scatter lasers conserva el otro — ese fallo era nuestro, de la v1.59 (#86). Y los Guardian Defenders solo enseñan el arma pesada cuando hay plataforma de verdad en la escuadra (#87).",
