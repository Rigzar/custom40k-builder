...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v158h_dismissed';
...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    ...
    line3: '🖨 Everyone — two fixes from one player’s screenshots. A squad whose sergeant carries something different now counts correctly: a five-model Terminator Squad listed 5x Storm bolter, 5x Power fist AND 5x Power sword — eleven weapons on five models — because the app only read a loadout line starting with “Every” and never saw the sergeant’s. It is 4x + 4x for the Terminators and 1x + 1x for the sergeant now (also Rubric Marines, Dark Commune, Incubi, Dynasty Phaeron). And weapons with two firing profiles no longer print nameless: a Lieutenant’s Plasma pistol showed only “— Standard” and “— Overcharged” with the weapon’s name nowhere on the card. That affected 61 weapons across ten factions, not just that one.',
  ...
  de: {
    ...
    line3: '🖨 Für alle — zwei Korrekturen aus den Screenshots eines Spielers. Ein Trupp, dessen Sergeant etwas anderes trägt, wird jetzt richtig gezählt: Eine Terminatoreinheit mit fünf Modellen listete 5x Sturmbolter, 5x Energiefaust UND 5x Energieschwert — elf Waffen auf fünf Modellen — weil die App nur eine mit „Every“ beginnende Ausrüstungszeile las und die des Sergeants nie sah. Jetzt sind es 4x + 4x für die Terminatoren und 1x + 1x für den Sergeant (ebenso Rubric Marines, Dark Commune, Incubi, Dynasty Phaeron). Und Waffen mit zwei Feuerprofilen werden nicht mehr namenlos gedruckt: Bei der Plasmapistole eines Lieutenant standen nur „— Standard“ und „— Overcharged“, der Waffenname fehlte auf der Karte. Betroffen waren 61 Waffen in zehn Fraktionen, nicht nur diese eine.',
  ...
  es: {
    ...
    line3: '🖨 Para todos — dos arreglos salidos de las capturas de un jugador. Una escuadra cuyo sargento lleva algo distinto ya se cuenta bien: una Terminator Squad de cinco listaba 5x Storm bolter, 5x Power fist Y 5x Power sword — once armas para cinco modelos — porque la app solo leía la línea de equipo que empieza por “Every” y nunca veía la del sargento. Ahora son 4x + 4x para los Terminators y 1x + 1x para el sargento (también Rubric Marines, Dark Commune, Incubi y Dynasty Phaeron). Y las armas con dos perfiles de disparo ya no se imprimen sin nombre: la pistola de plasma de un Lieutenant salía solo como “— Standard” y “— Overcharged”, sin el nombre del arma en ninguna parte. Afectaba a 61 armas de diez facciones, no solo a esa.',
