...
const ANNOUNCEMENT_KEY = 'c40k_announcement_v173b_dismissed';
...
const ANNOUNCEMENT_TEXT: Record<Language, AnnouncementLang> = {
  en: {
    ...
    line6: "🙂 THE APP NO LONGER TELLS YOU OFF FOR AN UNFINISHED LIST. A 2485-point Pitched Battle army used to show a red ✗ and \"1 errors\", when all that was happening is that the list was not done yet. It is now a plain note: \"15 points to go to reach 2500\". Going OVER the limit is still an error.",
    line7: "🔮 SMITE'S DESCRIPTION WAS THE OLD ONE — it still said \"1D3 Mortal Wounds\" on a psyker's power list. Smite is three automatic hits at Strength 5, AP -1, Damage 1, Seeking, which is what the rest of the app already said.",
    line8: "🔍 THESE ARE THE FIRST RESULTS, NOT THE LAST. The check is still running, so expect more fixes in the next versions. Keep reporting anything that looks wrong — your reports are what tell us where to look first.",
    line9: "",
  ...
  de: {
    ...
    line6: "🙂 DIE APP SCHIMPFT NICHT MEHR ÜBER EINE UNFERTIGE LISTE. Eine Pitched-Battle-Armee mit 2485 Punkten zeigte ein rotes ✗ und \"1 errors\", obwohl die Liste einfach noch nicht fertig war. Jetzt steht dort schlicht: \"Noch 15 Punkte bis 2500\". ÜBER dem Limit bleibt ein Fehler.",
    line7: "🔮 SMITES BESCHREIBUNG WAR DIE ALTE — in der Kräfteliste stand noch \"1D3 Mortal Wounds\". Smite sind drei automatische Treffer mit Stärke 5, AP -1, Schaden 1, Seeking, so wie es der Rest der App längst sagte.",
    line8: "🔍 DAS SIND DIE ERSTEN ERGEBNISSE, NICHT DIE LETZTEN. Die Prüfung läuft weiter, es kommen also weitere Korrekturen in den nächsten Versionen. Meldet weiterhin alles, was falsch aussieht — eure Meldungen sagen uns, wo wir zuerst hinschauen.",
    line9: "",
  ...
  es: {
    ...
    line6: "🙂 LA APP YA NO TE RIÑE POR UNA LISTA SIN TERMINAR. Un ejército de 2485 puntos en Pitched Battle salía con una ✗ roja y \"1 errors\", cuando lo único que pasaba es que la lista aún no estaba acabada. Ahora es una nota normal: \"Faltan 15 puntos para 2500\". Pasarse del límite sigue siendo error.",
    line7: "🔮 LA DESCRIPCIÓN DE SMITE ERA LA VIEJA — en la lista de poderes seguía diciendo \"1D3 Heridas Mortales\". Smite son tres impactos automáticos con Fuerza 5, AP -1, Daño 1, Seeking, que es lo que ya decía el resto de la app.",
    line8: "🔍 ESTOS SON LOS PRIMEROS RESULTADOS, NO LOS ÚLTIMOS. La revisión sigue, así que habrá más arreglos en las siguientes versiones. Seguid reportando cualquier cosa que parezca mal — vuestros reportes son lo que nos dice dónde mirar primero.",
    line9: "",
