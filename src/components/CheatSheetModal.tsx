...
const RANGED_TEXT: Record<Language, RangedText> = {
  en: {
    ...
    notes: '**Notes:** cover needs **50%+** of the unit in it, only one type at a time, and none if both sides share the same terrain · **Obscuring** terrain/units give only **−1 to hit** (no save/AP benefit) · the **Take Cover** reaction gives +1 save & −1 AT vs ranged · **6+ hits** force a Morale test (see the Morale card).',
  },
  de: {
  ...
  es: {
    ...
    notes: '**Notas:** la cobertura necesita **50%+** de la unidad dentro, solo un tipo a la vez, y ninguna si ambos bandos comparten el mismo terreno · el terreno/unidades **Obscuring** solo dan **−1 para impactar** (sin bono de salvación/AP) · la reacción **Take Cover** da +1 a la salvación y −1 AT contra disparo · **6+ impactos** fuerzan un test de Moral (ver la carta de Morale).',
  },
};
