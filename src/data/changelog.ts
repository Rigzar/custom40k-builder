...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      'Chaos Space Marines — two units now carry the name the codex gives them: the "Exalted Plague Champion" is the "Foetid Virion", and "Chaos Bikers" is "Chaos Biker". Lists that already contain them keep working — the old names still resolve — but if one of your lists comes back wrong, tell us on Discord and send us its .json and we will repair it and send it back.',
