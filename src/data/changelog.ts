...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      'ADMIN — the Inquisitor panel can now edit the landing announcement banner (enable/disable, version, and per-language title/intro/lines/footer) and toggle each faction\'s availability, both stored server-side and applied live on the landing page (which falls back to the built-in defaults if the settings can\'t be loaded).',
