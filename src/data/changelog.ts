...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      'Multi-language support: English, German (Deutsch) and Spanish (Español). Flag selector in the top bar switches the full UI on the fly — landing page, army config, unit cards and print view all translate without a page reload.',
