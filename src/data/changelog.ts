...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      'GENERAL — fix: opening Print View could blank the whole app. A print card called a hook (useLanguage) after an early return for units that fail to resolve, violating the rules of hooks and crashing the render; the hook now runs before any early return.',
