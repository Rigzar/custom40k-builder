...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: '0.36',
    date: '2026-05-30',
    title: 'Chaos Space Marines — auditoría completa',
    changes: [
      'Se revisaron las 61 fichas de unidades CSM comparando contra la fuente oficial. Las 12 armerías de vehículos (Chaos Land Raider, Predator, Rhino, Vindicator, Defiler, Dreadclaw, Foetid Bloat-Drone, Forgefiend, Helbrute, Heldrake, Maulerfiend y Venomcrawler) ahora permiten comprar equipamiento del armario como indica la regla. Las 7 promociones de campeón de escuadra (Boss Mutant, Aspiring Chaos Biker Champion, Aspiring Cultist Champion, Aspiring Jakhal Champion, Mutant Boss, Aspiring Raptor Champion y Aspiring Twistbray) también tienen acceso correcto a la armería.',
      'Se añadieron los perfiles de armas que faltaban en múltiples unidades — aparecían como opción seleccionable pero al elegirlas no mostraban estadísticas: modos de disparo del Combi-flamer y Combi-melta en vehículos, perfiles de Plasma gun en Chaos Bikers, Legionnaires, Raptors y Traitor Guard, Missile launcher en Helbrute y Legionnaires, los dos modos del Impaler chainglaive del Lord Discordant, los modos Cleave y Scythe del Manreaper de los Deathshroud Terminators, y los perfiles del Witchcane de la Dark Commune.',
      'Se corrigieron opciones de equipamiento que no respetaban las reglas: en Chaos Bikers y Raptors, el swap de "dos modelos" ahora limita correctamente a dos en vez de uno. En Eightbound, Tzaangors, Tzaangor Enlightened, Traitor Guard y Chaos Spawn, cada modelo elige su mejora de forma independiente. Los Jump Packs de los Possessed ahora se cobran por modelo. Los Rubric Marines corrigen que cada modelo puede cambiar su arma individualmente, y el segundo Soulreaper cannon de escuadras de 9 vuelve a estar disponible.',
      'Se corrigieron errores en los datos de varias unidades: la Dark Commune ahora muestra el equipo de los cuatro tipos de modelo (antes solo aparecía el de los Dark Executioners). Los Accursed Cultists muestran el equipo del Torment. Los Jakhals muestran el equipo del Dishonored. El Daemon Prince tenía el texto de Psyker dentro del tipo de unidad en lugar de en las habilidades. Los Mutants tenían dos mejoras a 0 puntos en vez de 1. El Reaper chaincannon de los Legionnaires tenía daño -1 en vez de 1. Los Juggernaut Hellriders tenían una Granada de Fragmentación duplicada que en realidad era una Granada Krak. El Plagueburst Crawler no mostraba sus dos grupos de opciones de swap ni los perfiles de su Entropy cannon. Los Blightlord Terminators, Myphitic Blight-Hauler y Obliterator también tenían perfiles de arma que faltaban.',
      'Se arreglaron los indicadores de bonificación de marca: al asignar una marca de Khorne, Nurgle o Slaanesh a una unidad, la ficha ahora muestra la bonificación correspondiente (+1 Ataque para Khorne, +1 Resistencia para Nurgle, +1 Iniciativa para Slaanesh). Antes solo Tzeentch mostraba su efecto (Warded). Las bonificaciones para personajes, criaturas monstruosas y vehículos también son ahora las correctas según el tipo de unidad.',
      'Se corrigieron los rasgos de ejército CSM para que solo apliquen a unidades con la palabra clave "Chaos Space Marine" — antes también se aplicaban a World Eaters, Death Guard, Thousand Sons y Emperor\'s Children, lo cual era incorrecto según las reglas. Los Poxwalkers ahora generan error si superan en número a las unidades de Plague Marines (regla Slaves of Darkness). Los Chosen ahora generan error si hay más unidades de Chosen que selecciones de HQ.',
      'Se añadieron o corrigieron las tablas de juego del arquetipo Daemonkin (Blood Tithe, Tally of Pestilence, Dark Pledge y Cabbalistic Rituals) para que aparezcan como referencia en el panel del arquetipo. Las 7 promociones de campeón ya mencionadas (Aspiring Jakhal Champion, Traitor Sergeant, Aspiring Twistbray y otras) que antes no estaban implementadas ahora aparecen correctamente en la ficha.',
      'Se añadieron dos reglas de validación que no existían: los Legados de la Hydra, el Señor del Hierro y el Espectro de la Noche ahora muestran error si alguna unidad del ejército lleva marca de Khorne, Nurgle, Slaanesh o Tzeentch (esos legados solo permiten unidades sin marca o con Undivided). El rasgo Iron Within, Iron Without ahora avisa si se asigna a unidades que ya tienen salvación invulnerable propia.',
    ],
  },
  {
    version: '0.35',
