...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      'Chaos Space Marines — two specialisation costs on the Exalted Plague Champion were out of date: the Noxious Blightbringer now costs 8 points (was 5) and the Biologus Putrifier 17 points (was 10), as printed in codex 1.02. The unit is the one the codex now calls "Foetid Virion"; everything else about it already matched.',
