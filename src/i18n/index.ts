...
export type TranslationKey =
  ...
  | 'valOptionRequiresArchetype' | 'valOptionRequiresChoice' | 'valInquisitorOneUpgrade' | 'valOptionOnlyInArmy' | 'val2ndLegacyRequiresTrait' | 'valAssassinSelectionRule'
  | 'valNeedAtLeastSlot' | 'valSummoningNoMandatoryAop' | 'valSkirmishHqOncePerArmy' | 'valTroopsRatioFail' | 'valTroopsRatioOk' | 'valAllyArchetypeUnitNotAllowed'
  ...
  | 'unitNotInCodexTitle' | 'unitNotInCodexBody' | 'removeFromList' | 'valVeteranRequired' | 'valUndividedLegacyRestriction'
...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    hhCardDesc: 'Space Marine legions of the Age of Darkness',
    mgCardTitle: 'Forces of the Machine God',
    mgCardDesc: 'Secutarii of the Collegia Titanica',
    escCardDesc: 'Super-heavy vehicles and Gargantuan Creatures',
    assCardDesc: 'Operatives of the Officio Assassinorum',
    navWiki: 'Wiki',
    navLoginSignIn: 'Login / Sign in',
    ...
    unitTypeLabel: 'Type:',
    fromPtsLabel: 'from {pts} pts',
    weaponTypeLabel: 'Type',
    ptsSuffixLabel: '{pts} pts',
    tabFactions: 'Home',
    tabConfig: 'Config',
    tabArmy: 'Army',
    tabAllied: 'Allied',
    ...
    changeLabel: 'Change',
    changeFactionConfirm: 'Changing faction clears the units already in this list, because they do not exist in the new faction. Continue?',
    backToConfig: 'Archetype, Legacy, Traits and allies',
    ...
    reaverLordPickLabel: 'Reaver Lord — choose one item from any Space Marine or Chaos Space Marine Armory',
    ...
    transportCapacityLabel: 'Transport',
    ...
    valInquisitorOneUpgrade: '{unit}: an Inquisitor may be upgraded to a Priest OR a Psyker, not both.',
    ...
    valSummoningNoMandatoryAop: 'Summoning: Chaos Daemons units cannot fill mandatory AOP selections, so your Daemon {slot} does not count towards the minimum. The Daemonkin archetype ignores this rule.',
    ...
    valOnlyTwoTraits: 'Only {max} Army Trait(s) allowed (have {count}).',
    ...
    valIronWithin: 'Iron Within, Iron Without: {unit} already has a ward save and cannot benefit from this trait.',
    ...
    valSectorProtectorWarbandMin: 'Sector Lord: a Henchman Warband is 5-10 specialist models (have {count}).',
    valSectorLordAcolytes: 'Sector Lord: a Henchman Warband taken without an Inquisitor needs 5+ Acolytes (have {count}).',
    valScarabsAsTroopsCap: 'Only one Canoptek Scarabs unit may count as Troops per Warriors unit ({count} selected, {warriors} Warriors unit(s)).',
    valUnitNotInCodex: '“{unit}” ({count}) is not in this codex any more — it costs 0 points and shows nothing. Remove it, or pick the datasheet that replaced it.',
    valUnitRemovedFromCodex: '“{unit}” ({count}) was removed from the codex: {note} It costs 0 points and shows nothing. Remove it from the list.',
    valMinistorumThirdTraitPerUnit: 'Ministorum World: the free third Trait must be one paid per unit, and “{trait}” is paid per Wound/Hull point. Pick a different third Trait.',
    unitNotInCodexTitle: 'Not in this codex any more',
    unitNotInCodexBody: 'This datasheet was removed or renamed in a codex update. It contributes 0 points and has no profile, but it is still holding its slot.',
  ...
  de: {
    ...
    hhCardDesc: 'Space-Marine-Legionen zu Beginn der Dunklen Zeit',
    mgCardTitle: 'Streitkräfte des Maschinengottes',
    mgCardDesc: 'Secutarii der Collegia Titanica',
    escCardDesc: 'Über-schwere Fahrzeuge und gigantische Kreaturen',
    assCardDesc: 'Agenten des Officio Assassinorum',
    navWiki: 'Wiki',
    navLoginSignIn: 'Anmelden / Registrieren',
    ...
    unitTypeLabel: 'Typ:',
    fromPtsLabel: 'ab {pts} Pkt.',
    weaponTypeLabel: 'Typ',
    ptsSuffixLabel: '{pts} Pkt.',
    tabFactions: 'Fraktionen',
    tabConfig: 'Konfig',
    tabArmy: 'Armee',
    tabAllied: 'Verbündet',
    stepFaction: 'Fraktion',
    ...
    changeLabel: 'Ändern',
    changeFactionConfirm: 'Ein Fraktionswechsel löscht die Einheiten, die bereits in dieser Liste stehen — in der neuen Fraktion gibt es sie nicht. Fortfahren?',
    backToConfig: 'Archetyp, Legacy, Traits und Verbündete',
    ...
    reaverLordPickLabel: 'Reaver Lord — einen Gegenstand aus einer beliebigen Space-Marine- oder Chaos-Space-Marine-Armory wählen',
    ...
    valInquisitorOneUpgrade: '{unit}: ein Inquisitor darf zum Priester ODER zum Psioniker aufgewertet werden, nicht zu beidem.',
    ...
    valSummoningNoMandatoryAop: 'Beschwörung: Einheiten aus dem Chaos-Daemons-Codex können keine PFLICHT-Slots der AOP füllen, dein Dämonen-{slot} zählt also nicht zum Minimum. Der Archetyp Daemonkin ignoriert diese Regel.',
    ...
    valOnlyTwoTraits: 'Nur {max} Armee-Eigenschaft(en) erlaubt (haben {count}).',
    ...
    valSectorProtectorWarbandMin: 'Sector Lord: ein Gefolgsleute-Warband hat 5-10 Spezialistenmodelle (hat {count}).',
    valSectorLordAcolytes: 'Sector Lord: ein Gefolgsleute-Warband ohne Inquisitor braucht 5+ Akolythen (hat {count}).',
    valScarabsAsTroopsCap: 'Pro Krieger-Einheit darf nur eine Canoptek-Skarabäen-Einheit als Standard zählen ({count} gewählt, {warriors} Krieger-Einheit(en)).',
    valUnitNotInCodex: '„{unit}“ ({count}) steht nicht mehr in diesem Codex — kostet 0 Punkte und zeigt nichts an. Entferne die Einheit oder wähle das Nachfolge-Datenblatt.',
    valUnitRemovedFromCodex: '„{unit}“ ({count}) wurde aus dem Codex entfernt: {note} Kostet 0 Punkte und zeigt nichts an. Bitte aus der Liste entfernen.',
    valMinistorumThirdTraitPerUnit: 'Ministorum World: die kostenlose dritte Eigenschaft muss pro Einheit bezahlt werden, „{trait}“ wird pro Wunde/Rumpfpunkt bezahlt. Bitte eine andere dritte Eigenschaft wählen.',
    unitNotInCodexTitle: 'Nicht mehr in diesem Codex',
    unitNotInCodexBody: 'Dieses Datenblatt wurde in einem Codex-Update entfernt oder umbenannt. Es kostet 0 Punkte und hat kein Profil, belegt aber weiterhin seinen Slot.',
  ...
  es: {
    ...
    hhCardDesc: 'Legiones Space Marine en los albores de la Herejía',
    mgCardTitle: 'Fuerzas del Dios Máquina',
    mgCardDesc: 'Secutarii del Collegia Titanica',
    escCardDesc: 'Vehículos super pesados y Criaturas Gargantuescas',
    assCardDesc: 'Operativos del Officio Assassinorum',
    navWiki: 'Wiki',
    navLoginSignIn: 'Iniciar sesión / Registrarse',
    ...
    unitTypeLabel: 'Tipo:',
    fromPtsLabel: 'desde {pts} pts',
    weaponTypeLabel: 'Tipo',
    ptsSuffixLabel: '{pts} pts',
    ...
    changeLabel: 'Cambiar',
    changeFactionConfirm: 'Cambiar de facción borra las unidades que ya hay en esta lista, porque no existen en la facción nueva. ¿Continuar?',
    backToConfig: 'Arquetipo, Legacy, Traits y aliados',
    ...
    reaverLordPickLabel: 'Reaver Lord — elige un objeto de cualquier armería de Space Marines o Chaos Space Marines',
    ...
    transportCapacityLabel: 'Transporte',
    ...
    valInquisitorOneUpgrade: '{unit}: un Inquisidor puede mejorarse a Sacerdote O a Psíquico, no a los dos.',
    ...
    valSummoningNoMandatoryAop: 'Invocación: las unidades de Chaos Daemons no pueden cubrir selecciones obligatorias del AOP, así que tu {slot} demoníaco no cuenta para el mínimo. El arquetipo Daemonkin ignora esta regla.',
    ...
    valOnlyTwoTraits: 'Solo se permiten {max} Rasgo(s) de Ejército (tienes {count}).',
    ...
    valIronWithin: 'Iron Within, Iron Without: {unit} ya tiene un ward save y no puede beneficiarse de este trait.',
    ...
    valSectorProtectorWarbandMin: 'Sector Lord: un Henchman Warband son 5-10 modelos especialistas (tiene {count}).',
    valSectorLordAcolytes: 'Sector Lord: un Henchman Warband sin Inquisidor necesita 5+ Acólitos (tiene {count}).',
    valScarabsAsTroopsCap: 'Solo una unidad de Canoptek Scarabs puede contar como Tropa por cada unidad de Warriors ({count} seleccionadas, {warriors} unidad(es) de Warriors).',
    valUnitNotInCodex: '«{unit}» ({count}) ya no está en este códex — cuesta 0 puntos y no muestra nada. Quítala o elige la hoja que la sustituye.',
    valUnitRemovedFromCodex: '«{unit}» ({count}) se eliminó del códex: {note} Cuesta 0 puntos y no muestra nada. Quítala de la lista.',
    valMinistorumThirdTraitPerUnit: 'Ministorum World: el tercer Rasgo gratuito debe pagarse por unidad, y «{trait}» se paga por Herida/Punto de Casco. Elige otro tercer Rasgo.',
    unitNotInCodexTitle: 'Ya no está en este códex',
    unitNotInCodexBody: 'Esta hoja se eliminó o se renombró en una actualización del códex. Cuesta 0 puntos y no tiene perfil, pero sigue ocupando su hueco.',
