...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    valTroopsRatioFail: '{label} must be ≥25% of total ({pct}%, need {needPts} pts).',
  ...
  de: {
    ...
    valTroopsRatioFail: '{label} muss ≥25% der Gesamtpunkte sein ({pct}%, benötigt {needPts} Pkt).',
    valTroopsRatioOk: '{label}: {pct}% (≥25%).',
  ...
  es: {
    ...
    valTroopsRatioFail: '{label} debe ser ≥25% del total ({pct}%, se necesitan {needPts} pts).',
    valTroopsRatioOk: '{label}: {pct}% (≥25%).',
