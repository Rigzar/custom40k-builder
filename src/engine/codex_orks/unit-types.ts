...
export const ORK_UNIT_TYPES: OrkUnitTypeEntry[] = [
  ...
  { name: 'Cybork Slashas', unit_type: 'Infantry' },
  { name: 'Kommandos', unit_type: 'Infantry' },
  { name: 'Mekboyz', unit_type: 'Character Model, Infantry' },
  { name: 'Mekboy Junka', unit_type: 'Vehicle' },
  { name: 'Nobz', unit_type: 'Infantry' },
  { name: 'Painboyz', unit_type: 'Character Model, Infantry' },
  { name: 'Tankbustas', unit_type: 'Infantry' },
  // Fast Attack
  { name: 'Deffkoptas', unit_type: 'Jetbike' },
  ...
  { name: 'Flash Gitz', unit_type: 'Infantry' },
  { name: 'Hunta Rig', unit_type: 'Vehicle' },
  { name: 'Killa Kans', unit_type: 'Walker' },
  { name: 'Kill Rig', unit_type: 'Vehicle' },
