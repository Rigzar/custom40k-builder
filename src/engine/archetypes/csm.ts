...
function _buildCSMArchetypes(): Record<string, ArchetypeRule> {
  ...
  'Daemonkin': { ...BASE,
    ...
    notes: [
      ...
      '1pt â€” Unbound Fury: target unit gains Furious Charge until end of round.',
      '1pt â€” Obliteration: target unit gains Decimate until end of round.',
      '1pt â€” Desecration: if within 3" of uncontested objective, seize it (as Objective Secured).',
      '2+xpt â€” Reborn in Blood: heal 3 Wounds +1 per extra pt spent (dead models may be revived).',
      '4pt â€” Blood for the Blood God: place 8 Bloodletters within 8" of a Khorne unit via Deep Strike (counts as activated, may still fight in melee).',
      '8pt â€” Skulls for his Throne: place 1 Bloodthirster within 8" of a Khorne unit via Deep Strike (counts as activated, may still fight in melee).',
      ...
      '1pt â€” Beautiful Death: target (about to be removed) may fight once more in melee.',
      '1pt â€” Dance Macabre: place 6 Daemonettes within 6" of a Slaanesh unit via Deep Strike (may still fight in melee).',
      '1pt â€” Diabolic Majesty: target enemy must pass Leadership test at -2.',
      '1pt â€” Protection of Dark Prince: target gains Aegis(4+), Warded, cannot be wounded on a 1 or 2.',
      '1pt â€” Violent Crescendo: target gains Frenzy(2").',
      '3pt â€” Siren\'s Call: place 1 Keeper of Secrets within 6" of a Slaanesh unit via Deep Strike (may still fight in melee).',
      ...
      '1+pt â€” Enhanced Manifestation: +6" range per CP spent.',
      '1+pt â€” Brotherhood of Sorcerers: +1 to test result per CP spent.',
      '1pt â€” Pact from Beyond: ignore Perils of the Warp.',
      '2pt â€” Cabbalistic Focus: power cannot be denied.',
      '2pt â€” Psychic Maelstrom: additionally resolve Smite from the caster.',
      '3pt â€” Residual Magic: until next activation, choose one: +6" range to ranged weapons / +1 Strength / 6+ invulnerability save.',
    ],
  },
