 ...
 *    Conclave, Renegades, Swift as the Wind) — slot/troops/composition rules → engine/archetypes/space-marines.ts
 ...
 *    prayers) → engine/legacies/sm-legacies.ts, surfaced in ArmoryModal / power pickers.
 *  - Traits (incl. Red Thirst, Black Rage interactions) → engine/traits/space-marines.ts (applied via
 *    the shared trait-effects pipeline in resolver.ts).
 *  - Forlorn Brothers "Black Rage" composition + uniqueness rules → engine/validators/space-marines.ts.
