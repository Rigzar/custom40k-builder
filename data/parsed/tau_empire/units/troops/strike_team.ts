...
export const strikeTeam: Unit = {
  ...
  "equipped_with": "All Fire Warriors and the Fire Warrior Shas'la are equipped with: Photon grenades; Pulse rifle; Pulse pistol.",
  "weapons": [
    {
  ...
  "option_groups": [
    {
      "header": "Any model may swap their Pulse rifle",
      "constraint": {
        "type": "every"
      },
      "choices": [
