...
export const landSpeeder: Unit = {
  ...
  "variant_models": [],
  "equipped_with": "A Land Speeder is a single model and equipped with: Heavy flamer.",
  "weapons": [
    {
      "name": "Assault cannon",
      "range": "24\"",
  ...
  "option_groups": [
    {
      "header": "Every model may swap their Heavy flamer",
      "constraint": {
        "type": "every"
      },
      "choices": [
    ...
    {
      "header": "Every model may be equipped with",
      "constraint": {
        "type": "every"
      },
      "choices": [
