...
export const platoonCommandSquad: Unit = {
  ...
  "option_groups": [
    {
      "header": "The following units can/must be selected for each Platoon Command Squad. All selections including Platoon Command Squad occupy a single Troops slot and count as Troops:\n- 2-5 Infantry Squads\n- 0-1 Conscript Infantry Platoon\n- 0-2 Special Weapon Squads\n- 0-3 Heavy Weapon Teams",
      "constraint": {
        "type": "one"
      },
      "choices": [],
  ...
  "abilities": [
    "Chain of command: Units that activate within 12\" of the Lieutenant can receive orders as if an officer were in range.",
