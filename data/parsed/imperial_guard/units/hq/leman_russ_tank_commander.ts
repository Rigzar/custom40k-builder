...
export const lemanRussTankCommander: Unit = {
  "name": "Leman Russ Tank Commander",
  "models": [
    {
      "name": "Leman Russ Tank Commander",
      "points": 288,
  ...
  "variant_models": [],
  "equipped_with": "A Leman Russ Tank Commander is equipped with: Punisher gatling cannon; Heavy flamer.",
  "weapons": [
    {
      "name": "Battle cannon",
      "range": "72\"",
  ...
  "option_groups": [
    {
      "header": "Only one Leman Russ Tank Commander per army.",
      "constraint": {
        "type": "unique_upgrade"
      },
      "choices": [],
  ...
  "abilities": [
    ...
    "Officer: A Leman Russ Tank Commander issues 1 order."
  ],
  "unit_type": "Vehicle",
  "keywords": [],
  "is_vehicle": true,
