...
export const sistersNovitiate: Unit = {
  ...
  "option_groups": [
    {
      "header": "Two Sister Novitiate may swap their Autoguns",
      "constraint": {
        "type": "fixed_max",
        "max": 2
      },
  ...
  "abilities": [
    ...
    "In training: The army can't have more units of Sister Novitiates than it has Battle Sisters squads."
  ],
  "unit_type": "Infantry",
  "keywords": [],
  "is_vehicle": false,
