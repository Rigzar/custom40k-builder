...
export const skitariiRangers: Unit = {
  ...
  "variant_models": [],
  "equipped_with": "Every model is equipped with: Bionics; Galvanic rifle.",
  "weapons": [
    {
      "name": "Arc rifle",
      "range": "24\"",
  ...
  "option_groups": [
    {
      "header": "One Ranger may be equipped with",
      "constraint": {
        "type": "one"
      },
      "choices": [
    ...
    {
      "header": "For every 10 models, up to two Rangers may swap their Galvanic rifles",
      "constraint": {
        "type": "per_n",
        "per_n": 10,
        "count_per_n": 2
