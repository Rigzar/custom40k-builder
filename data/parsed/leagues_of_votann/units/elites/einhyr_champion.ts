...
export const einhyrChampion: Unit = {
  ...
  "abilities": [
    ...
    "Honor or Death: At the start of this model's activation, if an enemy HQ or Character is within 10\", its placed Order is converted to Charge. The Einhyr Champion and its attached unit must use the Order to engage in close combat with the enemy HQ or character model."
  ],
