...
export const firePrism: Unit = {
  ...
  "variant_models": [],
  "equipped_with": "A Fire Prism is equipped with: Prism cannon; Twin shuriken catapult.",
  "weapons": [
    {
    ...
    },
    {
      ...
      "ap": "-5",
      "d": "4",
      "abilities": "AT(4), Beam, Decimate, Lance(+2)"
    }
  ],
  "option_groups": [
    {
