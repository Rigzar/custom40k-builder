...
export const bigMek: Unit = {
  ...
  "abilities": [
    ...
    "Shokk attack gun: Roll for the strength of the weapon after you have selected a target. If doubles are rolled, consult the following table — 1-1: Awups! The Mek and its unit gain a Battleshock token and suffer an automatic hit S:D AP:-4 D:3. 2-2: Grah! The new target is the nearest visible unit not in melee (including Orks!). 3-3: Oops! An opponent chooses a new target (including Orks!). 4-4: Splash! Profile changes to Assault 2, S:6 AP:-3 D:1, Blast(6), Suppression(3). 5-5: Big wrong button! Remove the Mek from the field and redeploy via Deep Strike; it can no longer move. 6-6: Big red button! The weapon fires with Strength D and AT(3) and loses Blast(6) this activation."
  ],
