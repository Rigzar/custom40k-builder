/**
 * LOOTED VALKYRIE — Dedicated Transport
 *
...
export const lootedValkyrie: Unit = {
  "name": "Looted Valkyrie",
  "models": [
    {
      "name": "Looted Valkyrie",
      "points": 202,
  ...
  "variant_models": [],
  "equipped_with": "Every Looted Valkyrie is equipped with: Multi-laser.",
  "weapons": [
    {
      "name": "Heavy bolter",
      "range": "36\"",
  ...
  "option_groups": [
    ...
    {
      "header": "Can be equipped with two Heavy bolters for +27 points.",
      "constraint": {
        "type": "one"
      },
      "choices": [],
  ...
  "abilities": [
    "Anti-Grav, Fast, Flyer, Hover mode",
